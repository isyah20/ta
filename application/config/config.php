...
if (!is_cli()) {
    ...
    $config['api_url'] .= "://beetend:76oZ8XuILKys5@" . $_SERVER['HTTP_HOST'];
}
if (!is_cli()) {
    // $config['api_url'] = ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http");
    $config['api_url'] =  ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ? "https" : "http") . "://beetend:76oZ8XuILKys5@" . $_SERVER['HTTP_HOST'];
    // $config['api_url'] .= str_replace(basename($_SERVER['SCRIPT_NAME']), "", $_SERVER['SCRIPT_NAME']);
}
