        ...
        <div class="overflow-auto">
            <div id="example_wrapper" class="mt-3 py-4 px-4 profile-bg">
                <div class="button_place">
                    <a href="kategori-lpse/create" disable="disabled" class="uh_button" type="button">
                        <iconify-icon inline icon="ic:round-plus" style="color: white;"></iconify-icon> Tambah
                    </a>
                </div>
                <table id="kategorilpse" class="display" style="width:100%" aria-describedby="example_info">
                    <thead>
                        <tr class="t_head">
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            // DataTable({
                            $('#kategorilpse').DataTable({
                                processing: true,
                                serverSide: true,
                                order: [],
                                ajax: {
                                    url: "<?= base_url('admin/KategoriLpse/getdata') ?>",
                                    type: "POST"
                                },
                                columnDefs: [{
                                    target: [-1],
