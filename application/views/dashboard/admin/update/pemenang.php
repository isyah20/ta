        ...
        <h5 class="mt-4 mb-4">Tambah Data <?=$title?></h5>
            ...
            <form method="post" action="">
                <div class="mb-3">
                    ...
                    <select name="id_tender" class="form-select" id="" disabled="disabled">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="" name="npwp" value="<?=$pemenangs['npwp']?>">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label" style="font-size:14px">Harga Negosiasi</label>
                    <input type="text" class="form-control" id="" name="harga_negosiasi" value="<?=$pemenangs['harga_negosiasi']?>">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label" style="font-size:14px">Harga Kontrak</label>
                    <input type="text" class="form-control" id="" name="harga_kontrak" value="<?=$pemenangs['harga_kontrak']?>">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label" style="font-size:14px">Nilai PDN</label>
                    <input type="text" class="form-control" id="" name="nilai_pdn" value="<?=$pemenangs['nilai_pdn']?>">
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label" style="font-size:14px">Nilai UMK</label>
                    <input type="text" class="form-control" id="" name="nilai_umk" value="<?=$pemenangs['nilai_umk']?>">
                </div>
