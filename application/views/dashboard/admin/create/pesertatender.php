<section id="pesertatender" class="pesertatender">
    <div class="container dash-admin" style="padding:30px">
        ...
        ?>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="" name="harga_penawaran" >
                </div>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label" style="font-size:14px">Harga Terkoreksi</label>
                    <input type="text" class="form-control" id="" name="harga_terkoreksi" >
                </div>
