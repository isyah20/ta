...
<section>
  <div class="container" style="color: white;">
      <div class="row">
        <div class="col">
          <table class="table custom-table-pm custom-table-container">
            <thead class="custom-thead">
              <tr>
                <th></th>
                <th class="text-center custom-padding">No.</th>
                <th class="custom-padding">Nama Peserta</th>
                <th class="custom-padding">Tender Yang Dimenangkan</th>
                <th class="custom-padding">Nilai HPS</th>
                <th class="custom-padding">Tanggal Menang</th>
              </tr>
            </thead>
            <tbody class="tbody mb-5" style="padding-top: 10px;">
              <tr>
                <th></th>
