    ...
    <div class="row">
        <div class="col-lg-8 px-lg-0 px-3">
            ...
            <div class="row justify-content-center mx-0 mt-lg-0 mt-4 px-1 filter">
                ...
                <!-- <div class="col-lg py-2 px-0 mx-1 my-1 d-flex align-items-center" style="max-height: 50px important; max-width: 250px;">
                ...
                <div class="col-lg">
                    <div class="d-flex align-items-center mx-0">
                        ...
                        <div class="col align-items-center mx-1 pt-3">
                            <p class="m-0 p-0" id="placeHps" style="font-weight: 400; font-size: 14px; color: #694747;">
                                1M - 10M</p>
    ...
    ?>
            ...
            <div class="">
                ...
                <div class="row justify-content-center mb-2">
                    ...
                    <div class="col-lg col-5 m-lg-1 mx-2 mb-4 p-2 card-market">
                        <div class="text-uppercase">
                            <h6 class="judul2">Tender Batal batal aja</h6>
                        </div>
                        <div class="d-flex">
            ...
            <table class="table m-0" style="box-shadow:none;">
                <thead class="" style="position:sticky;top: 0; z-index: 1;">
                    <tr>
                        ...
                        <th scope="col" class="align-middle mx-1">Nama Peserta apa ini</th>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg col-5 mx-lg-1 mx-2 p-2 card-market">
                            ...
                            <div class="d-flex" style="color:#553333;">
                                <h3 class="m-0" style="font-weight: 700;" id="isi2_1">
                                    0
                                </h3>
...
<script>
                    ...
                    $.each(json['jenisPengadaan'], function(key, item) {
                        ...
                        if (cekJenisPengadaan.length > 0 && cek < cekJenisPengadaan.length) {
                            if (item['id_jenis'] === cekJenisPengadaan[cek]) {
                                tampilanJenisPengadaan += `
                                <input type="checkbox" id="jenisPengadaan` + i + `" name="jenisPengadaan" value="` +
                                    item['id_jenis'] + `" onclick="setJenisPengadaan(` + i + `)" checked>
                                        `;
                                cek++;
                            } else {
                                tampilanJenisPengadaan += `
                                <input type="checkbox" id="jenisPengadaan` + i + `" name="jenisPengadaan" value="` +
                                    item['id_jenis'] + `" onclick="setJenisPengadaan(` + i + `)">
                                        `;
                            }
                        } else {
                            tampilanJenisPengadaan += `
    ...
    function setChart() {
            ...
            if (dataHps[0]['forecastingHps'] >= 0) {
                ...
                $('#forecastingHps').html(
                    ...
                    <div class="col-2 d-flex align-items-center flex-row" style="color:#BF0C0C;">
                        ...
                        <h6 class="my-0" style="font-size: 12px;">` + dataHps[0]['forecastingHps'].toString().replace(
                        '-', '') + `%</h6>
                    </div>
        ...
        if (getDataTender !== "") {
            ...
            if (dataTender[0]['forecastingTender'] >= 0) {
                ...
                $('#forecastingTender').html(
                    ...
                    <div class="col-2 d-flex align-items-center flex-row" style="color:#BF0C0C;">
                        <img src="<?= base_url() ?>assets/img/rowDown.svg" alt="">
                        <h6 class="my-0" style="font-size: 12px;">` + dataTender[0]['forecastingTender'].toString()
                    .replace('-', '') + `%</h6>
                    </div>
                    <h6 class="col-10 m-0" style="font-size: 12px;">Menurun pada bulan berikutnya</h6>
                    `
        ...
        $('#isi3_total').html(sum_chart2_1 + sum_chart3_2 + sum_chart3_3);
    ...
    function showCard(data) {
        $.ajax({
            url: "<?= base_url('market/getPenggunaById') ?>" + id = "isi2_1",
            type: 'POST',
            dataType: 'json',
            success: function(data) {
                $('#cardTitle').html(data.title);
                $('#cardText').html(data.text);
            },
