...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
<span class="preheader">Berikut adalah tagihan untuk pembelian Anda pada <?= $purchaseDate ?>. Harap lakukan pembayaran paling lambat <?= $dueDate ?></span>
...
<p class="f-fallback sub"><?= $paymentInstructionUrl ?></p>
                            </td>
                          </tr>
                        </table>
                        <table class="attributes" width="100%" cellpadding="0" cellspacing="0" role="presentation">
