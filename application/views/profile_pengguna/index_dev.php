            ...
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    ...
                    <div class="text-center mb-2">
                        ...
                        <button class="btn btn-outline-danger mt-2" id="btn-resend" style="padding: 3px 10px;" onclick="kirimOTP(0)">Kirim Ulang</button>
                    </div>
                </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8 col-xl-9">
                                    <div class="d-flex">
                                        ...
                                        <div class="ms-2">
                                            <button class="btn btn-success" id="btn-verifikasi" onclick="kirimOTP(1)">Verifikasi WhatsApp</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8 col-xl-9">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <span data-id="showPassword" class="fa fa-fw fa-eye-slash field-icon-l toggle-password"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8 col-xl-9">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ms-2">
                                            <span data-id="showPassword2" class="fa fa-fw fa-eye-slash field-icon-l toggle-password"></span>
                                        </div>
                                    </div>
                                </div>
                            </div>
