                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                    <tr>
                        <td width="400">
                            ...
                            <h4 style="margin: 5px 0 10px 0; font-weight: 400;">Daftar tender terbaru sesuai dengan preferensi Anda</h4>
                            <a href="<?= $baseurl ?>/user-dashboard" class="btn">Lihat Semua Tender Terbaru<a>
                        </td>
                        <td width="200">
                    ...
                    <?php if ($isUserFree) : ?>
                        <tr>
                            <td colspan="2">Total tender terbaru: <span style="background: #FFF2F2;border: 1px solid #B02D19;padding: 5px;font-size: 16px;"><strong><?= $count_tender ?></strong></span> paket
                            </td>
                        </tr>
                        <tr>
                            <td height="20" colspan="2"></td>
