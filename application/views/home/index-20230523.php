...
<section>
	<div class="container p-4">
		<div class="row pb-4">
			<div class="col-md-5 col-lg-6 d-flex justify-content-center wow fadeInUp" data-wow-delay="0.1s">
				<img src="<?= base_url("assets/img/homepage-illustration.svg") ?>" alt="homepage-illustration.svg" width="400">
			</div>

			<div class="col-md-7 col-lg-6 what_tender wow fadeInUp" style="padding:30px; text-align:justify" data-wow-delay="0.3s">
				...
				<p style="font-size:22px">Sebuah <i>platform</i> yang menyediakan layanan terbaik untuk menampung seluruh tender di setiap LPSE yang ada di Indonesia dengan memiliki fitur-fitur yang dapat memberikan Anda kemudahan dalam melihat progres tender yang Anda ikuti.</p>
			</div>
		</div>
	</div>
</section>
	...
	<div class="container-fluid" data-aos="zoom-out">
		<div class="container-fluid d-flex justify-content-center mb-4 mb-auto p-2 bd-highlight">
			<div class="row justify-content-center gy-4">
				...
				<div class="col-md-3 mx-4 px-xl-5 d-flex justify-content-center align-self-center wow fadeInUp" data-wow-delay="0.6s">
					<img src="<?= base_url("assets/img/statistic_tender.svg") ?>" alt="">
					<div class="data_count align-self-center">
						<div class="number3">
							<h3 style="letter-spacing: -0.01em;color: #000000;" id="number3">
								<!--<iconify-icon inline icon="line-md:loading-twotone-loop"></iconify-icon>-->
								<?= number_format($statistik['total_tender'], '0', ',', '.') ?>
							</h3>
						</div>
...
<section id="tender_home" class="tender py-5">
	<div class="container">
		<div class="text-center">
			<h1 class="tender-title text-uppercase text-center wow fadeInUp d-inline-block px-3 pb-2" data-wow-delay="0.1s">Tender</h1>
		</div>
       ...
       <?php /* <div class="row">
        ...
        <div id="pagination-container" class="wow fadeInUp" data-wow-delay="0.5s"></div>
				...
				<div class="col-lg-8 col-md-8 wow fadeInLeft" data-wow-delay="0.1s">
					...
					<div class="  text-2 mb-3 mb-lg-4">
						...
						<div>
							...
							<button class="dot-fitur mx-2" onclick="currentSlidefitur(2)">Supplier</button>
							<button class="dot-fitur" onclick="currentSlidefitur(3)">Asosiasi</button>
						</div>
					</div>
				</div>

				<div class="col-lg-3 col-md-3 text-center align-self-center wow fadeIn" data-wow-delay="0.5s">
...
<section id="testimoni_home" class="container my-5">
	<div class="row gy-4">
		<div class="col-lg-3 col-md-12 align-self-center wow fadeInUp" data-wow-delay="0.1s">
			<div class="testi-a">
		...
		<div class="col-2 col-md-4 col-lg-2 wow fadeInUp" data-wow-delay="0.5s">
			<img src="<?= base_url("assets/img/illustration_testimoni.svg") ?>" style="width: 325px;margin-left: -74px;">
		</div>

		<div class="col-10 col-lg-7 col-md-8 wow fadeInUp" data-wow-delay="0.7s">
			<div class="row">
...
<section id="partner" class="partner">
	<div class="slideshow-container">
		<h5 class="mb-4 wow fadeInDown" data-wow-delay="0.1s"><strong>Partnered with over 20+ Company around Indonesia</strong></h5>
...
<section id="artikel" class="artikel py-5">
	<div class="container" data-aos="fade_up">
		...
		<div class="card-body">
			<div class="row">
				<div class="mb-3 col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.3s">
					<div class="article-item h-100 d-flex flex-column justify-content-between mt-2">
						<div class="overflow-hidden card-custom bg-white border d-flex align-items-start flex-column rounded-4 h-100">
							...
							<div class="p-3 over-headline">
								<span class="text-muted font-weight-light small mb-1 d-block">Berita | 16 November 2022</span>
								<h6 class="artikel headline mb-1 fw-semibold">
									<a href="" class="d-block">Pembaritahuan Migrasi Server LPSE Kabupaten</a>
								</h6>
								<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
							</div>
							<a href="" class="px-3 pb-3 mt-auto">Read More<i class="fas fa-arrow-right ms-2"></i></a>
						</div>
					</div>
				</div>

				<div class="mb-3 col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.5s">
					<div class="article-item h-100 d-flex flex-column justify-content-between mt-2">
						<div class="overflow-hidden card-custom bg-white border d-flex align-items-start flex-column rounded-4 h-100">
							<div class="position-relative overflow-hidden over-shadow w-100">
								<img class="artikel artikel-img" src="<?= base_url("assets/img/artikel.png") ?>" alt="">
				...
				<div class="mb-3 col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.7s">
					<div class="article-item h-100 d-flex flex-column justify-content-between mt-2">
						<div class="overflow-hidden card-custom bg-white border d-flex align-items-start flex-column rounded-4 h-100">
							<div class="position-relative overflow-hidden over-shadow w-100">
								<img class="artikel artikel-img" src="<?= base_url("assets/img/artikel.png") ?>" alt="">
				...
				<div class="mb-3 col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.9s">
					<div class="article-item h-100 d-flex flex-column justify-content-between mt-2">
						<div class="overflow-hidden card-custom bg-white border d-flex align-items-start flex-column rounded-4 h-100">
							<div class="position-relative overflow-hidden over-shadow w-100">
								<img class="artikel artikel-img" src="<?= base_url("assets/img/artikel.png") ?>" alt="">
                                ...
                                <div class="p-card bg-white p-3 p-lg-4 rounded-4 border hover-scale">
                                        ...
                                        <div class="d-flex flex-row align-items-center">
                                            <div class="profiles">
                                                <div class="ms-2">
                                                    ...
                                                    <span><i class="fa fa-clock-o me-1"></i>`+update_hari+`</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="link d-flex flex-row align-items-center">
                                            <span><a class="btn btn-sm border" href="`+data[i].link_sumber+`"><i class="fa fa-link me-1"></i> Sumber Tender</a></span>
                                        </div>
                                    </div>
                                </div>
                            </div>`;
                ...
                tender += 
                    `<div class="paket col-md-6">
                        <div class="p-card bg-white p-3 p-lg-4 rounded-4 border hover-scale">
                            <div class="d-flex align-items-center border-bottom pb-3">
                                <div class="d-flex flex-row align-items-center">
                                    <img class="rounded-circle me-1" src="https://seeklogo.com/images/D/Departemen_Pekerjaan_Umum-logo-7E29323DFE-seeklogo.com.png" width="45">
                                </div>
                                <div class="d-flex flex-row align-items-center">
                                    <div class="profiles">
                                        <div class="ms-2">
