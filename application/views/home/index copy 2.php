								...
								$.each(json['lpse'], function(key, item) {
									...
									<li class="row mx-1 my-2">
										<div class="col-1 text-center d-flex align-items-center mx-2">
											<input type="checkbox" id="klpd`+item['id_lpse']+`" name="klpd" value="`+item['id_lpse']+`">
										</div>
										<h6 class="col-9 p-0 m-0 d-flex align-items-center">
											<label for="klpd`+item['id_lpse']+`"> `+item['nama_lpse']+`</label>
										</h6>
									</li>
									`;
								});
			...
			<script>
				function getJenisPengadaan(){
					$.ajax({
						...
						success: function(json) {
							console.log(json);
							jenisPengadaan = `<div class="d-none"></div>`;
							if (json['jenisPengadaan'] !== null){
								$.each(json['jenisPengadaan'], function(key, item) {
									...
									<li class="row mx-1 my-2">
										<div class="col-1 text-center d-flex align-items-center mx-2">
											<input type="checkbox" id="jenisPengadaan`+item['id_jenis']+`" name="jenisPengadaan" value="`+item['id_jenis']+`">
										</div>
										<h6 class="col-9 p-0 m-0 d-flex align-items-center">
							...
							$('#listJenisPengadaan').html(jenisPengadaan);
						}
					});
				}
			</script>
								...
								success: function(json) {
									...
									if (json['wilayah'] !== null){
										$.each(json['wilayah'], function(key, item) {
											...
											<li class="row mx-1 my-2">
												<div class="col-1 text-center d-flex align-items-center mx-2">
													<input type="checkbox" id="wilayah`+item['id_wilayah']+`" name="wilayah" value="`+item['id_wilayah']+`">
												</div>
												<h6 class="col-9 p-0 m-0 d-flex align-items-center">
							...
							success: function(json) {
								...
								if (json['tahapan'] !== null){
									$.each(json['tahapan'], function(key, item) {
										...
										<li class="row mx-1 my-2">
											<div class="col-1 text-center d-flex align-items-center mx-2">
												<input type="checkbox" id="tahapan`+item['id_tahapan']+`" name="tahapan" value="`+item['id_tahapan']+`">
											</div>
											<h6 class="col-9 p-0 m-0 d-flex align-items-center">
