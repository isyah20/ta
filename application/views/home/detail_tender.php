					...
					<div class="row">
						<div class="col-md-6">
							...
							<div class="row m-0 py-3 border-bottom">
								...
								<div class="col-10 ps-0">
									<span class="col-rincian fw-semibold d-block">Nilai Pagu Paket</span>
                                    <?php $nilaiPagu = ($tender->nilai_pagu ?? '0');
$nilaiPagu = number_format($nilaiPagu, 0, ',', '.'); ?>
                                    <span><?= 'Rp ' . $nilaiPagu ?></span>
								</div>
							</div>
							<div class="row m-0 py-3 border-bottom">
								<div class="col-2 text-center">
								...
								<div class="col-10 ps-0">
                                    ...
                                    <?php $nilaiHPS = ($tender->nilai_hps ?? '0');
$nilaiHPS = number_format($nilaiHPS, 0, ',', '.'); ?>
                                    <span><?= 'Rp ' . $nilaiHPS ?></span>
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="row m-0 py-3 border-bottom">
								<div class="col-2 text-center">
									<img src="<?= base_url('assets/img/icon-steps.png') ?>" width="30" alt="icon-steps.png">
								</div>
								<div class="col-10 ps-0">
									<span class="col-rincian fw-semibold d-block">Tahap Tender Saat Ini</span>
                                    <!--<button type="button" class="btn btn-link text-danger p-0" data-bs-toggle="modal" data-bs-target="#modalTahapan"><?= $tender->tahap_tender ?></button>-->
							...
							<div class="row m-0 py-3 border-bottom">
								...
								<div class="col-10 ps-0">
									<span class="col-rincian fw-semibold d-block">Peserta Tender</span>
                                    <span><?= ($tender->peserta_tender ?? '0') ?> peserta</span>
								</div>
							</div>
							<div class="row m-0 py-3 border-bottom">
								<div class="col-2 text-center">
								...
								<div class="col-10 ps-0">
									<span class="col-rincian fw-semibold d-block">Akhir Pendaftaran</span>
                                    <span><?= ($tender->akhir_daftar ?? '-') ?></span>
								</div>
							</div>
						</div>	
					</div>	
