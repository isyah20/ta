...
class Midtrans
{
    ...
    public const SANDBOX_BASE_URL = 'https://api.sandbox.veritrans.co.id/v2';
    public const PRODUCTION_BASE_URL = 'https://api.veritrans.co.id/v2';
    ...
    public static function remoteCall($url, $server_key, $data_hash, $post = true)
    {
        ...
        if ($result === false) {
            ...
            if ($info['http_code'] != 201 && !in_array($result_array->status_code, [200, 201, 202, 407])) {
