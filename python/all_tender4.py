...
#scrap detail paket
cursor.execute("SELECT lpse.id_lpse,url,kode_tender FROM paket,lpse WHERE paket.id_lpse=lpse.id_lpse AND nama_tender IS NULL AND YEAR(tanggal_pembuatan)=2004 ORDER BY RAND()")
