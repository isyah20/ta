...
cursor.execute("SELECT id_lpse,url FROM lpse WHERE id_lpse BETWEEN 525 AND 551 AND id_lpse NOT IN (SELECT id_lpse FROM history_scrap WHERE DATE(tgl_scrap)=CURRENT_DATE) ORDER BY RAND()")
